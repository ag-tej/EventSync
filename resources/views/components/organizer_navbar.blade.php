@auth
    <nav class="navbar">
        <aside class="flex items-center space-x-8">
            <a href="{{ route('organizer.dashboard') }}" class="flex items-center space-x-1">
                <img alt="logo" src="{{ asset('svg/favicon.svg') }}" width="25" decoding="async" loading="lazy">
                <div>
                    <p class="text-white text-xl font-mono leading-5">EventSync</p>
                ...
                <div
                    ...
                    <div class="flex flex-col">
                        <a href="{{ route('organizer.dashboard') }}"
                            class="p-2 rounded hover:bg-purple/10 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 18" stroke-width="1.5"
                    ...
                    <hr class="border-gray-500">
                    <div class="flex flex-col">
                        <a href="{{ route('settings') }}" class="p-2 rounded hover:bg-purple/10 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
